  ...
  return (
    <>
      ...
      <p className="text-lg text-pink-900 mb-6">
        Read what your companions have to say about productivity!
      </p>
        ...
        {testaments.map((testament) => (
          <motion.button
            ...
            className={`p-4 rounded-lg transition-all text-left
              ${selectedTestament === testament.id ? 'ring-2 ring-pink-500' : 'hover:ring-1 hover:ring-pink-300'}
            `}
            style={{
      ...
      <AnimatePresence mode="wait">
        {selectedTestament && (
          ...
          >
            <div 
              className="absolute left-0 top-0 bottom-0 w-[1px] bg-pink-200 ml-8"
              style={{
                boxShadow: '1px 0 0 rgba(255,192,203,0.25)'
              }}
            />
            <pre 
