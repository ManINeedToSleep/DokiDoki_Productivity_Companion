    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="relative h-full flex-grow overflow-hidden rounded-full bg-pink-200">
              <div
      ...
      <p className="absolute text-pink-600 font-['Halogen'] transform -translate-y-4 text-xs tracking-wide">
        {Math.round(value)}
      </p>
    </>
  );
